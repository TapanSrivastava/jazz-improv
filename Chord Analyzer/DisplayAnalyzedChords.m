...
//To Do-- Add clef display functionality

@interface DisplayAnalyzedChords ()

@end

@implementation DisplayAnalyzedChords
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return self.chordList.chordList.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    for (Chord *chord in self.chordList.chordList)
    {
        NSString* string = chord.chordName;
